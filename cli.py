...
def _run_lint_gate(biz_dict: str, sys_dict: str) -> bool:
    ...
    from tools.ontology.extractors.dictionary_linter import lint_dictionaries
...
def cmd_extract(args: argparse.Namespace) -> int:
    ...
    from tools.ontology.registry.builder import build_registry
...
def cmd_validate(args: argparse.Namespace) -> int:
    ...
    from tools.ontology.extractors.dictionary_extractor import extract_terms
    from tools.ontology.extractors.tag_scanner import scan_codebase
    from tools.ontology.registry.builder import OrphanAnchorError, build_registry
...
def cmd_embed(args: argparse.Namespace) -> int:
    ...
    from tools.ontology.embeddings.client import embed_registry
